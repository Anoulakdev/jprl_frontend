...
const EditForm: React.FC = () => {
  ...
  useEffect(() => {
    ...
    axiosInstance
      .get<Activity>(`/meetings/${decryptedId}`)
      .then((response) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axiosInstance.put(`/meetings/${act.id}`, updatedFormData);
              ...
              <div className="mb-4.5 flex flex-col gap-4.5 xl:flex-row">
                ...
                <div className="w-full xl:w-1/2">
                  <label className="text-body-md mb-3 block font-medium text-dark dark:text-white">
                    ຫົວ​ຂໍ້ປະ​ຊຸມ <span className="text-red">*</span>
                  </label>
                  <input
                    type="text"
                    name="name"
                ...
                <div className="w-full xl:w-1/2">
                  <label className="mb-3 block text-body-sm font-medium text-dark dark:text-white">
                    ມື້​ເລີ່ມປະ​ຊຸມ <span className="text-red">*</span>
                  </label>
